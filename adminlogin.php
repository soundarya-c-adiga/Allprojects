...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item">
	   ...
	   <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu my-2 my-lg-0" aria-labelledby="navbarDropdown">
          <a class="dropdown-item new1" href="#">Manager Signin</a>
   ...
   <h2 style="color:blue">ADMIN LOGIN FORM</h2><br>
   ...
   <fieldset >
   <button type="submit" name="submit" class="btn btn-primary" onClick="location.href='foodlist.php'">Login</button><br>or if you dont have an account 
   <button type="button" onClick="location.href='adminsignup.php'" class="btn btn-primary">SignUp</button>
   </fieldset>
...
$link=connect();
 ...
 if(isset($_POST['submit']))
 {
	 ...
	 else if($password=="")
	 {
		 ...
		 $query="select * from `asignup` where `email`='$email' and `password`='$password';";
